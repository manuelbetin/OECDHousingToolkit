cf_param_paragraph_page_1=function(ctry_code,ctry_name,
  ...
  what_rhp=function(gr_hp, ctry_code, ctry_name){
    if (gr_hp$rate<0){
  ...
  sentence3=paste0("Real house prices and rent prices have risen strongly in many countries since the 1990s with prices increasing by more than 100% in those countries experiencing the largest increases (Figure b, c). ",what_rhp(gr_hp, ctry_code, ctry_name), ".")

  sentence4=paste0("Finally, mortgage markets play a crucial role in housing markets since housing generally constitutes the household's single largest financial outlay. The share of households' mortgage claims in terms of GDP in ", ctry_name," is ", what_mortg(avg_mortg, mortgage_data_myctr,myctry_hh, ht_avg_OECD)," (Figure d).")
