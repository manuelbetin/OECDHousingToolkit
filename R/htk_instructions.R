htk_instructions=function(){
  ...
  cat(" the key message and two collapsible section of details: 1) the first one (Cross country experiences)")
  cat(" focuses on the policy outcomes from a cross country perspective and is split")
  cat(" in two sections i) Policy description and rationale and ii) Impact of policies 2) the second one")
  cat("(Country experiences) sheds light on specific countries and the policies they have implemented \n\n")
  cat("Definitions\n")
