htk_instructions=function(){
  ...
  cat(" be apply to the document when transformed into html.\n \n")
  ...
  cat("The template is structured as following: 5 main sections\n\n")
  cat("Context\n")
  ...
  cat("\t - One paragraph explaining the main policy challenges\n\n")
  cat("Issues at Stake\n")
  cat("\t - as many subsections as relevant economic outcome with a pagraph of explaination and a figure\n\n")
  cat("Policy recommandations\n")
  cat("\t - as many subsections as relevant policy recommendation with for each an introductory paragraph with ")
  cat(" the key message and a collapsible chunk containing more details: with a subsection 'Policy description and")
  cat(" rational' and another 'Impact of policies'\n\n")
  cat("Data source\n")
  ...
  cat("The template contains example for three type of plots that are available with the follwoing functions\n")
  cat("- htk_scatterplot()\n")
  cat("- htk_lineplot()\n")
  cat("- htk_barplot()\n")
  cat("If you want to include more figures just copy and paste the chunk of code and adjust to what you want\n")
  cat("To create a new chunk of code click on the button insert at the top of the find and select R.\n")
  cat("Inside the chunk you can use standard R code and manipulate the data as you wish.\n")
  cat("Please refers to the documentation for more details. For further help contact:\n")
  cat("boris.cournede@oecd.org, nguyen.maxime@oecd.org or manuel.betin@oecd.org\n\n")
