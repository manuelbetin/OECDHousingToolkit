...
var_names=c("Price to income","House price\nvolatility", "Mortgage claims")
sec_col=c("goldenrod")
...
var_names=c("Home ownership", "overburden","overcrowding")
