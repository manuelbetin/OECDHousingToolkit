...
<<<<<<< HEAD
fig_eff=htk_CyC(dt_effic, ranking_eff, params$ctry_code,var_codes_eff,var_names_eff, sec_col_eff, title="Efficiency Outcomes")
=======
...
<<<<<<< HEAD
fig_incl=htk_CyC(dt_incl,ranking_incl, params$ctry_code,var_codes_incl,var_names_incl,sec_col, title="Inclusiveness Outcomes")
=======
...
sec_col=c("darkgreen")
<<<<<<< HEAD
fig_sust=htk_CyC(dt_sust,ranking_sust, params$ctry_code,var_codes_sust,var_names_sust, sec_col, title="Sustainability Outcomes")
=======
...
sec_col=c("grey")
<<<<<<< HEAD
htk_policyradar(dt_pol,ranking_pol, params$ctry_code,var_codes_pol,var_names_pol, title="Policy")
=======
