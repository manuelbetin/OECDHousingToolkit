...
<div class="context">
<h2> Context </h2> 
<button data-toggle="collapse" data-target="#id1"> → </button>
...
<h2> Outcomes </h2>
<button data-toggle="collapse" data-target="#id2"> → </button>
...
<button data-toggle="collapse" data-target="#id3"> → </button>
...
<h2> Data sources </h2>
<button data-toggle="collapse" data-target="#id4"> → </button>
...
<button data-toggle="collapse" data-target="#id5"> → </button>
