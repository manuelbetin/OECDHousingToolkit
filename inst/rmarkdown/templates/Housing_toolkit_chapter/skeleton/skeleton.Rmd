...
<button data-toggle="collapse" data-target="#id3"class="btn"><i class="fa fa-bars"></i></button>
...
<h2>Definitions </h2>
<button data-toggle="collapse" data-target="#id4"class="btn"><i class="fa fa-bars"></i></button>
...
<button data-toggle="collapse" data-target="#id5"class="btn"><i class="fa fa-bars"></i></button>
...
<button data-toggle="collapse" data-target="#id6"class="btn"><i class="fa fa-bars"></i></button>
